            ...
            <div className='mt-5'>
                ...
                <div className='flex flex-col gap-3'>
                    {pastStories.map((story, index) => {
                        const formattedDate = moment(story.createdAt).local().format('MMMM Do YYYY, h:mm:ss A');
                        return (
                            <div className='border p-5 flex gap-2 justify-between rounded-lg' key={index}>
                                <div>
                                     <span className='uppercase font-semibold'>{story.prompt}</span>
